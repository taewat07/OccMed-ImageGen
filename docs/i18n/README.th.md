...
| --- | :---: | --- | --- |
| [`openai/gpt-5.4-image-2`](https://openrouter.ai/openai/gpt-5.4-image-2) | ✅ | ผลลัพธ์ภาพ **$30 / 1 ล้าน tokens** (**~฿1,009**) | สร้างภาพร่วมกับการให้เหตุผลของ GPT-5.4 |
| [`google/gemini-3.1-flash-image-preview`](https://openrouter.ai/google/gemini-3.1-flash-image-preview) | ✅ | ผลลัพธ์ภาพ **$60 / 1 ล้าน tokens** (**~฿2,018**) | ร่างภาพเร็ว แก้ภาพ และเลือกความละเอียด 512 ถึง 4K |
| [`google/gemini-3-pro-image-preview`](https://openrouter.ai/google/gemini-3-pro-image-preview) | ✅ | ผลลัพธ์ภาพ **$120 / 1 ล้าน tokens** (**~฿4,036**) | เลย์เอาต์ซับซ้อน ตัวอักษรหลายภาษา และงาน 2K/4K |
| [`x-ai/grok-imagine-image-quality`](https://openrouter.ai/x-ai/grok-imagine-image-quality) | ✅ | **$0.05 / ภาพ 1K** (**~฿1.68**) หรือ **$0.07 / ภาพ 2K** (**~฿2.35**) | ภาพสมจริง ตัวอักษรในภาพ และการแก้ภาพจากภาพอ้างอิง |
...
| --- | --- | ---: |
| `low` | ร่างภาพเร็วและทดลอง prompt | ~$0.004 · ~฿0.13 |
| `medium` | สมดุลระหว่างคุณภาพและราคา | $0.0355–$0.0361 · ~฿1.19–฿1.21 |
| `high` | รายละเอียดสูงสุดและภาพสำหรับใช้งานจริง | $0.132–$0.133 · ~฿4.44–฿4.47 |

ช่วงราคา Medium และ High มาจากบันทึกค่าใช้จ่ายจริงบน OpenRouter ของภาพด้านล่าง ส่วนบันทึกที่ให้มาไม่มีภาพคุณภาพ Low จึงยังใช้ค่าประเมินจากราคาปัจจุบันของ OpenRouter ที่ $30 ต่อ 1 ล้าน GPT Image 2 output-image tokens ขนาดภาพ prompt และภาพอ้างอิงที่ต่างกันอาจทำให้ค่าใช้จ่ายสุดท้ายเปลี่ยนไป ตรวจราคาปัจจุบันได้จาก [หน้าโมเดล GPT Image 2](https://openrouter.ai/openai/gpt-image-2)
...
| แพ็กเกจ ChatGPT | ราคาที่ประกาศ | คิดเป็นเงินบาทโดยประมาณต่อเดือน | สิทธิ์สร้างภาพที่ประกาศไว้ | งบเท่ากันสร้างภาพ Medium ราคา ~฿1.20 |
| --- | ---: | ---: | --- | ---: |
| Free | $0 | ฿0 | จำกัดจำนวนและช้ากว่า | ไม่คิดเทียบ เพราะใช้ฟรี |
| Go | $8/เดือน | ~฿269/เดือน | มากกว่า Free แต่ไม่ได้ประกาศจำนวนภาพตายตัว | ~224 ภาพ |
| Plus | $20/เดือน | ~฿673/เดือน | สร้างงานซับซ้อนได้ดีขึ้น แต่ยังมีขีดจำกัด | ~561 ภาพ |
| Pro | $200/เดือน | ~฿6,727/เดือน | ไม่จำกัดและเร็วกว่า ภายใต้ข้อกำหนดป้องกันการใช้งานผิดประเภท | ~5,606 ภาพ |
