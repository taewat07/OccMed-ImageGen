...
| --- | --- | ---: |
| `low` | ร่างภาพเร็วและทดลอง prompt | ประมาณ $0.004 · ฿0.13 *(ค่าประเมิน)* |
| `medium` | สมดุลระหว่างคุณภาพและราคา | $0.0355–$0.0361 · ฿1.19–฿1.21 *(ค่าใช้จ่ายจริง)* |
| `high` | รายละเอียดสูงสุดและภาพสำหรับใช้งานจริง | $0.132–$0.133 · ฿4.44–฿4.47 *(ค่าใช้จ่ายจริง)* |
...
| $0.0361 · ประมาณ ฿1.21 | $0.0356 · ประมาณ ฿1.20 | $0.0355 · ประมาณ ฿1.19 |
...
| แพ็กเกจ ChatGPT | ราคาที่ประกาศ | คิดเป็นเงินบาทโดยประมาณต่อเดือน | สิทธิ์สร้างภาพที่ประกาศไว้ | งบเท่ากันสร้างภาพ Medium ราคาประมาณ ฿1.20 ได้ประมาณ |
| --- | ---: | ---: | --- | ---: |
